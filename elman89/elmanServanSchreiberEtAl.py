...
python elmanServanSchreiberEtAl.py 20000-60000-200000 50 3-15 0.01-0.015-0.02 0.1-0.5-0.7-0.9

Parameter1 : List of Number of sequences separated by -
Parameter2 : List of Window of average separated by -
Parameter3 : List of Number of neurons separated by -
Parameter4 : List of Learning rate separated by -
Parameter5 : List of Momentum separated by -
...
def elmanAnalysis(data,index_data, sequences ,window, nbNeuronHiddenLayer,learningRate, momentum):
    ...
    plt.clf()
    if len(mean_error)>100000:
        plt.plot(mean_error[0:10000])
    else:
        plt.plot(mean_error)
    ...
    plt.figtext(.05, .05, '\n Number of sequences : ' + str(NumberOfSequences) + '\nNumber of samples : ' + str(
        nbSamples) +'\n Number of hidden units : '+str(nbNeuronHiddenLayer)+ '\nAverage of the error every ' + str(window) + ' results'+ '\nLearning rate ' + str(learningRate)+ '\nMomentum ' + str(momentum))

    plt.savefig(str(index_data)+"_NetRes_NbSeq" + str(NumberOfSequences) + "-Win" + str(window) +"-nbHidU"+str(nbNeuronHiddenLayer)+ "-lr" + str(learningRate) + "-mom" + str(momentum) + ".png")  # save as png
...
if __name__ == '__main__':
    ...
    parameters.append("")#for size of sequences that is not fixed here in this article
            ...
            for nbNeuronHiddenLayer in listnbNeuronHiddenLayer:
                for learningRate in listlearningRate:
                    for momentum in listmomentum:
                        ...
                        data[index_data]["sizeOfSequence"] = ""
